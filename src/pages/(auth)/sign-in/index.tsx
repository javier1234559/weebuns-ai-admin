...
export default function LoginPage() {
  ...
  const roleDisplay = isAdmin ? "Quản trị viên" : isTeacher ? "Giáo viên" : "Học viên"


  const getLeftContentByRole = () => {
    const defaultContent = {
      title: "Nền tảng kết nối giáo viên và học viên hiệu quả",
      description: "Hỗ trợ giáo viên và quản trị viên quản lý lớp học, theo dõi tiến độ và tương tác với học viên một cách hiệu quả."
    }

    if (isAdmin) {
      return {
        title: "Quản lý trung tâm tiếng Anh hiệu quả",
        description: "Hệ thống quản lý toàn diện giúp điều hành trung tâm, theo dõi hiệu suất và tối ưu hóa vận hành."
      }
    }
    ...
    if (isTeacher) {
      return {
        ...
        description: "Hỗ trợ giáo viên quản lý lớp học, theo dõi tiến độ và tương tác với học viên một cách hiệu quả."
      }
    }
   ...
   <div className="container relative grid h-screen flex-col items-center justify-center lg:max-w-none lg:grid-cols-2 lg:px-0">
      ...
      <div className="relative hidden h-full flex-col bg-primary p-10 text-primary-foreground dark:border-r lg:flex overflow-hidden">
        ...
        <div className="relative z-20 flex items-center text-xl font-medium">
          ...
          <span className="text-primary-foreground font-bold">{globalConfig.APP_NAME}</span>
        </div>
        ...
        <div className="relative z-20 mt-20 space-y-4">
          ...
          <ul className="space-y-4 mt-8">
            <li className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold text-primary-foreground">Quản lý học liệu</h3>
                <p className="text-sm text-primary-foreground/70">Tổ chức nội dung giảng dạy và tài liệu học tập chuyên nghiệp</p>
              </div>
            </li>
            <li className="flex items-start">
              <div className="mr-4 rounded-full bg-primary-foreground/20 p-2">
              ...
              <div>
                <h3 className="font-semibold text-primary-foreground">Tương tác học viên</h3>
                <p className="text-sm text-primary-foreground/70">Giao tiếp hiệu quả với học viên và phụ huynh mọi lúc mọi nơi</p>
              </div>
            </li>
            <li className="flex items-start">
              <div className="mr-4 rounded-full bg-primary-foreground/20 p-2">
              ...
              <div>
                <h3 className="font-semibold text-primary-foreground">Quản lý lớp học</h3>
                <p className="text-sm text-primary-foreground/70">Theo dõi tiến độ, điểm danh và đánh giá học viên dễ dàng</p>
              </div>
            </li>
          </ul>
        </div>
